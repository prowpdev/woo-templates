...
?>
<h2 class="product_title entry-title services_heading _collection_heading">Collection Date</h2>
<fieldset class="wc-bookings-date-picker wc-bookings-date-picker-<?php echo esc_attr( $product_type ); ?> <?php echo esc_attr( implode( ' ', $class ) ); ?>">
	...
	<?php endif; ?>
	<section class="booking-field-inputs">
		<div class="row">
			<div class="item">
				<!-- <input type="date" name="" id="dad-date-picker" value="" /> -->
			</div>
			<div class="item">
				<div class="wc-bookings-date-picker-date-fields" class="temp-hidden" >
					...
					<label>
						...
						<input id="date-field-calendar"  type="text" autocomplete="off" name="<?php echo esc_attr( $name ); ?>_day" placeholder="<?php esc_attr_e( 'dd', 'woocommerce-bookings' ); ?>" size="2" class="booking_date_day" />
